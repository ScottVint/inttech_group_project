...
class Book(models.Model):
    ...
    author = models.ArrayField(models.CharField(max_length=MAX_AUTHOR_LENGTH))
    pages = models.IntegerField()
    blurb = models.TextField()
    cover_image = models.ImageField()
    wishlisted_by = models.ManyToManyField(User)
...
class ProgressRecord(models.Model):
    ...
    book = models.ForeignKey(Book, on_delete=models.SET_NULL, default=None)
...
class Details(models.Model):
    ...
    favourites = models.IntegerChoices()
